...
class UserView extends Component {
    ...
    componentDidMount() {
        ...
        axios.get(`http://temp-work.pl:8282/vehicles_sharing/reservations/`, {headers: {Authorization: `Token ${token}`}})
            .then(res => {
                let my = [];
                let someones = [];
    ...
    activate(id) {
        ...
        axios.post(`http://temp-work.pl:8282/vehicles_sharing/reservations/${id}/activate/`, {headers: headers});
    }
    ...
    deactivate(id) {
        ...
        axios.post(`http://temp-work.pl:8282/vehicles_sharing/reservations/${id}/deactivate/`, {headers: headers});
    }
