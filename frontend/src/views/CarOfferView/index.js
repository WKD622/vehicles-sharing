...
class CarOfferView extends Component {
    ...
    componentDidMount() {
        ...
        Promise.all([axios.get(`http://temp-work.pl:8282/vehicles_sharing/vehicles/`, {headers: {Authorization: `Token ${token}`}}),
                axios.get(`http://temp-work.pl:8282/vehicles_sharing/photos/`, {headers: {Authorization: `Token ${token}`}})])
            .then(([cars, photos]) => {
